...
const page = () => {
  ...
  return (
    <div className='flex'>
    <div className='absolute lg:top-8 m-4 lg:left-8  flex justify-center items-center gap-1/2'>
...
<span className='font-[30px] font-bold m-2'>HD</span>
    </div>
      
      <div className='flex flex-col gap-2 justify-center m-auto lg:ml-18 lg:w-1/2 min-h-screen'>
        <div className='flex flex-col'>
         <h1 className='font-bold text-[30px] ml-2'>Sign up</h1>
        <p className='text-[18px] text-[#969696] m-2 '>Sign up to enjoy the feature of HD</p>
        </div>
       ...
       <div className="relative w-full max-w-md mb-2">
          ...
          <label
            htmlFor="dob"
            className="absolute -top-2 left-2 px-1 bg-white text-gray-500 text-sm 
                       peer-focus:text-blue-500 transition-all"
          >
            Date of Birth
          </label>
        </div>
